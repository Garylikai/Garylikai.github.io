---
title: "AMS 550: Stochastic Models"
layout: single
classes: wide
permalink: /grad/ams550/
author_profile: true
description: "Personal academic record for AMS 550: Stochastic Models at Stony Brook University."
---
...
- *Introduction to Probability Models* by Sheldon M. Ross, 12th edition, 2019, Elsevier
...
3. Demonstrate an understanding of the concepts in Discrete Time Markov Chains:
    ...
    - Determine the transience and recurrence of a Markov chain;
...
4. Demonstrate an understanding of the concepts in Renewal Processes:
    ...
    - Model simple real-life problems using the renewal process and its generalizations such as the renewal reward process and the alternating renewal process.
...
6. Demonstrate an understanding of the basic concepts in Queueing Theory:
    ...
    - Apply continuous time Markov chain theory to study limiting properties of birth and death queues, e.g., stationary probabilities, average waiting time, expected number of customers in system;
