---
title: "AMS 553/CSE 529: Simulation and Modeling"
layout: single
classes: wide
permalink: /grad/ams553/
author_profile: true
description: "Personal academic record for AMS 553/CSE 529: Simulation and Modeling at Stony Brook University."
---
...
- *Simulation Modeling and Analysis* by Averill M. Law, 5th edition, 2014, McGraw-Hill
- *Simulation Modeling and Analysis* by Averill M. Law and W. David Kelton, 3rd edition, 1999, McGraw-Hill
...
4. Demonstrate an understanding of the concepts in input analysis:
    ...
    - Use the data collected from an actual process to fit an input distribution;
...
5. Demonstrate an understanding of the concepts in output analysis:
    - Understand the transient and steady state behavior of a simulation output process;
    - Familiarity with the tools used in analyzing terminating simulations;
    - Familiarity with the standard procedures used in analyzing non-terminating simulations, e.g., replication deletion, batch method, regenerative method;
